            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p><strong>@lang('general.avion') :</strong> {{ $vol->avion->modele ?? __('general.non_assigne') }}
                        </p>
                    </div>
                </div>

                <div class="mt-3">
                    {{-- Boutons admin seulement si connecté ET admin --}}
                    @auth
                        @if (optional(auth()->user())->role === 'admin')
                            <a href="{{ route('vols.edit', $vol->id) }}" class="btn btn-warning">
                    ...
                    <a href="{{ route('vols.index') }}" class="btn btn-secondary">
